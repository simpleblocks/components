...
key:d,ref:g,props:e,_owner:k}};var createContext=function(a,b){void 0===b&&(b=null);a={$$typeof:w$2,_calculateChangedBits:b,_currentValue:a,_currentValue2:a,_threadCount:0,Provider:null,Consumer:null};a.Provider={$$typeof:v$1,_context:a};return a.Consumer=a};var createElement=M;var createFactory=function(a){var b=M.bind(null,a);b.type=a;return b};var createRef=function(){return {current:null}};var forwardRef=function(a){return {$$typeof:x$1,render:a}};var isValidElement=O;
...
var require$$0$2 = /*@__PURE__*/getAugmentedNamespace(react_production_min$1);
...
var Definition$1 = {
    ...
    definition: {
        category: "Basic",
        icon: react.createElement(FontAwesomeIcon, { size: "3x", icon: faCube }),
        label: "Div",
    },
    // Rendering
    props: [],
...
var TextCanvas = function (_a) {
    var stateProps = _a.stateProps, htmlProps = _a.htmlProps; _a.children;
    return (react.createElement("span", __assign({}, htmlProps), stateProps.text));
};
